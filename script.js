...
const CriarItemDeAtividade = (atividade) => {
    ...
    let input = `<input value="${atividade.data}" type="checkbox" onchange="concluirAtividade(event)" `
...
const SalvarAtividade = (event) => {
    ...
    if(atividadeExiste) {
        return alert('Dia/Hora não disponíves!')
    }
